...
#sed -i '/exit/i\uci set wireless.@wifi-iface[0].encryption='psk2'' package/default-settings/files/zzz-default-settings
#sed -i '/exit/i\uci set wireless.@wifi-iface[0].key='73555071'' package/default-settings/files/zzz-default-settings
#sed -i '/exit/i\uci set wireless.@wifi-iface[1].encryption='psk2'' package/default-settings/files/zzz-default-settings
#sed -i '/exit/i\uci set wireless.@wifi-iface[1].key='73555071'' package/default-settings/files/zzz-default-settings
#sed -i '/exit/i\nuci commit wireless\n' package/default-settings/files/zzz-default-settings
